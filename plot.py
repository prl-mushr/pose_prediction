...
for topic, msg, t in bag.read_messages(topics=topics):
    if topic == '/car24/PoseStamped':
        ...
        count += 1
        if count == 1: continue
        pt24_T_w = transformerROS.fromTranslationRotation((ps_24[-1].x, ps_24[-1].y, ps_24[-1].z), (q_24.x, q_24.y, q_24.z, q_24.w))
        ...
        plt.plot([xs_24[-1], z24_T_w[0,3]], [ys_24[-1], z24_T_w[1,3]], '.-b')

        y24_T_pt24 = translate_transform([0,0.5,0])
        y24_T_w = np.matmul(pt24_T_w, y24_T_pt24)
        print('24', y24_T_w[1,3], ys_24[-1])
        ...
        plt.plot([xs_26[-1], z26_T_w[0,3]], [ys_26[-1], z26_T_w[1,3]], '.-b')

        y26_T_pt26 = translate_transform([0,0.5,0])
        y26_T_w = np.matmul(pt26_T_w, y26_T_pt26)
        print('26', y26_T_w[1,3], ys_26[-1])
